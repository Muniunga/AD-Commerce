...
<head>
    ...
    <title><?= $dados['titulo_pagina']?> | AD-Commerce</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="<?= ASSETS . THEME?>/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> adcommerce@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index"><img src="<?= ASSETS?>/commerce/images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="verificar"><i class="fa fa-crosshairs"></i> Verificar</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="produto-detalhes">Detalhes de Produto </a></li> 
